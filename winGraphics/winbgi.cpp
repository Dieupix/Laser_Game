...
public :
  ...
  bool is_empty(void) const { return d_put==d_get; }
  void put(POINTS pt)
  {
  ...
  friend void clearMouseQueue(void);
};
...
// rajouté
void fillrect(int left, int top, int right, int bottom, int c){
    int crt = getcolor();
    setcolor(c);
